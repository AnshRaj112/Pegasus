...
for p in ["src", "tgt"]:
    ...
    with tarfile.open(f"case9_{p}.tar", "w") as tar: tar.add(f"inner_{p}.tar")
cleanup_temps(["src.orc", "tgt.orc", "inner_src.zip", "inner_tgt.zip", "inner_src.tar", "inner_tgt.tar"])
print("Case 9 generated.")