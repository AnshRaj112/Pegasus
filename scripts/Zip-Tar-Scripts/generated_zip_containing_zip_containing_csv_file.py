...
for prefix in ["src", "tgt"]:
    ...
    with zipfile.ZipFile(f"case6_{prefix}.zip", "w") as z:
        z.write(f"inner_{prefix}.zip")

cleanup_temps(["src.csv", "tgt.csv", "inner_src.zip", "inner_tgt.zip"])
print("Case 6 generated.")