    ...
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
      ...
      <footer className="wizardActionFooter" style={{ justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: 'var(--md)' }}>
          <button style={{ padding: '0 var(--lg)', height: '40px', borderRadius: '8px', border: '1px solid var(--outline-variant)', background: 'var(--surface-container-lowest)', color: 'var(--on-surface-variant)', fontSize: 'var(--body-md)', fontWeight: 600, cursor: 'pointer' }}>
            Save Draft
          </button>
          <button 
