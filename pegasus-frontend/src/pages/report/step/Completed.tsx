...
const ReportSkeleton: React.FC = () => (
  <div className={styles.skeletonList} role="status" aria-live="polite" aria-label="Loading completed reports">
    <div className={styles.loadingText}>Loading completed reports...</div>
    {Array.from({ length: 3 }).map((_, index) => (
      <div key={`completed-skeleton-${index}`} className={styles.skeletonRow}>
...
export const Completed: React.FC = () => {
  ...
  const filtered = useMemo(() => completedReports.filter((r: ReportItem) =>
