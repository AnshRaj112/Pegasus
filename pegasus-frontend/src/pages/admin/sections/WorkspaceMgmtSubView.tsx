  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button style={{ backgroundColor: '#234B5F', color: '#ffffff', padding: '10px 24px', borderRadius: '8px', fontSize: '14px', fontWeight: 500, border: 'none', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
      ...
      <div className={styles.bentoGrid3}>
        <div className={styles.bentoCardLite}>
          <div style={{ height: '48px', width: '48px', borderRadius: '8px', backgroundColor: 'rgba(0, 87, 194, 0.1)', color: '#234B5F', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px' }}><TeamOutlined /></div>
        ...
        <div className={styles.bentoCardLite}>
          <div style={{ height: '48px', width: '48px', borderRadius: '8px', backgroundColor: 'rgba(70, 108, 228, 0.1)', color: '#234B5F', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px' }}><DatabaseOutlined /></div>
        ...
        <div className={styles.bentoCardLite}>
          <div style={{ height: '48px', width: '48px', borderRadius: '8px', backgroundColor: 'rgba(91, 92, 92, 0.1)', color: '#234B5F', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px' }}><HddOutlined /></div>
      ...
      <div className={styles.tableShell}>
        ...
        <div style={{ padding: '16px 24px', borderTop: '1px solid #c1c6d7', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fafafa' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <button style={{ width: '32px', height: '32px', borderRadius: '8px', backgroundColor: '#234B5F', color: '#ffffff', border: 'none', fontSize: '14px', fontWeight: 500 }}>1</button>
